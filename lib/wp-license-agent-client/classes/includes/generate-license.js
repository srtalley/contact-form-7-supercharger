            ...
            $.ajax({
                ...
                $.ajax({
                    ...
                    success: function( response ) {
                        ...
                        var wpla_check_license_response_block = '<p><strong>License Status:</strong> ' + response.license_data.message;
                        ...
                        if($(wpla_disable_functionality).val() == "true" && response.license_data.valid && response.license_data.disable_functionality) {
